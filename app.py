...
with st.spinner("Executing high-speed TradingView indicator streams..."):
...
if not results_df.empty:
    ...
    # Fixed: Converted to proper indented conditional layout blocks to remove manual text remnants
